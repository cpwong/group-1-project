...
export default function ViewChart(props) {
  ...
  useEffect( () => {
    ...
    console.log("ViewChartData: ", data);
  ...
  //   // Create root element
  //   // https://www.amcharts.com/docs/v5/getting-started/#Root_element
  //   var root = am5.Root.new("cryptochart");
  ...
  //   // Add series
  //   // https://www.amcharts.com/docs/v5/charts/xy-chart/series/
  //   var valueSeries1 = chart.series.push(
  //     am5xy.LineSeries.new(root, {
  //       name: "XTD",
  //       valueYField: "price1",
  //       calculateAggregates: true,
  ...
  //   var valueTooltip = valueSeries1.set(
  //     "tooltip",
  //     am5.Tooltip.new(root, {
  //       getFillFromSprite: false,
  //       getStrokeFromSprite: true,
  ...
  //   console.log("cryptoChartData: ",data);
  ...
  return (
    <div>
      <p className="title is-4 has-text-info-dark  mb-3">Historical Daily Rate</p>

      <div
        className="box has-background-info-light p-2"
        id="chartdiv"
